...
namespace Server.Misc
{
    public static class RaceDefinitions
    {
        ...
        public static void Configure()
        {
            ...
            RegisterRace(new Human(EnumRaces.Human, "Humans"));
            RegisterRace(new Elf(EnumRaces.Elf, "Elves"));
            RegisterRace(new Gargoyle(EnumRaces.Gargoyle, "Gargoyles"));

            //Custom AgeOfSaouls
            RegisterRace(new DarkElf(EnumRaces.DarkElf, "Dark Elves"));
            RegisterRace(new Orc(EnumRaces.Orc, "Orcs"));
            RegisterRace(new Vampire(EnumRaces.Vampire, "Vampires"));
            RegisterRace(new Dwarf(EnumRaces.Dwarf, "Dwarfs"));
            RegisterRace(new Demon(EnumRaces.Demon, "Demons"));
        }
        ...
        {
            public Human(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
        ...
        private class Elf : Race
        {
            ...
            public Elf(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 605, 606, 607, 608, Expansion.ML)
            {
            }
        ...
        private class Gargoyle : Race
        {
            ...
            public Gargoyle(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 666, 667, 402, 403, Expansion.SA)
            {
            }
        ...
        private class DarkElf : Race
        {
            public static readonly int rawStr = 85;
            public static readonly int rawDex = 15;
            public static readonly int rawInt = 125;
            private static readonly int[] m_SkinHues =
            {
                0xCE, 0x24D, 0x24E
            };
            ...
            public DarkElf(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 605, 606, 607, 608, Expansion.ML)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        {
            public Orc(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        private class Vampire : Race
        {
            public Vampire(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        private class Dwarf : Race
        {
            public Dwarf(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        private class Demon : Race
        {
            public Demon(EnumRaces eRace, string pluralName)
                : base(eRace, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
